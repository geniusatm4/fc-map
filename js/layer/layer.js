...
;!function (e, t) {
    ...
    var i, n, a = e.layui && layui.define, o = {
        ...
        v: "3.0", ie: function () {
            ...
            return e = e || {}, r.cache = o.config = i.extend({}, o.config, e), r.path = o.config.path || r.path, "string" == typeof e.extend && (e.extend = [e.extend]), e.extend ? (a ? layui.addcss("modules/layer/" + e.extend) : r.link("skin/" + e.extend), this) : this
        }, link: function (t, n, a) {
            if (r.path) {
            ...
            l.imgprev = function (e) {
                ...
                r.close(l.loadi), l.index = r.open(i.extend({
                    ...
                    area: function () {
                        ...
                        return !t.full && a[0] > o[0] && (a[0] = o[0], a[1] = a[0] * n.height / n.width), [a[0] + "px", a[1] + "px"]
                    }(),
                    title: !1,
                    shade: .9,
                    shadeClose: !0,
